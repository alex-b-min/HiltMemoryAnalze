package com.example.graffiti.segmented_button
...
import androidx.compose.ui.unit.dp
import com.example.graffiti.segmented_button.SegmentedButtonsDefaults.ITEM_ANIMATION_MILLIS
import com.example.graffiti.segmented_button.SegmentedButtonsDefaults.minimumHeight
import com.example.graffiti.segmented_button.SegmentedButtonsDefaults.outlineThickness
...
fun SegmentedButtons(
    ...
    border: BorderStroke = BorderStroke(outlineThickness, brush = Brush.linearGradient(colors = listOf(
        colors.outlineColor, // First color
        colors.outlineColor.copy(alpha = 0.8f) // Second color with slight transparency
    ))),
